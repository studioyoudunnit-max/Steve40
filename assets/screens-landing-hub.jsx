// Landing screen + Host hub
const { useState: useStateLH, useEffect: useEffectLH } = React;

// ═══════════════════════════════════════════
// LANDING
// ═══════════════════════════════════════════
function LandingScreen({ onHost, onJoin }) {
  const [code, setCode] = useStateLH('');
  return (
...
// HOST HUB
// ═══════════════════════════════════════════
function HostHub({ onGame, onEndGame }) {
  ...
  return (
    <Stage pad={false}>
      ...
      <div style={{
        ...
        {/* RIGHT — Player log (leaderboard-style) */}
...
Object.assign(window, { LandingScreen, HostHub });
