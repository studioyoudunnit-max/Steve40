// Player (mobile) view + scoreboards + finale
const { useState: useStateP, useEffect: useEffectP } = React;

// ═══════════════════════════════════════════
// PLAYER MOBILE — phone mockup showing the player's POV
// ═══════════════════════════════════════════
function PlayerMobile({ mode='trivia' }) {
  // mode: join | lobby | trivia | twink | lipsync | songpop | waiting
  const me = DEMO_PLAYERS[0]; // Raj
...
// ═══════════════════════════════════════════
function FinaleScreen({ onBack }) {
  const [reveal, setReveal] = useStateP(false);
  const [fire, setFire] = useStateP(0);
...
Object.assign(window, { PlayerMobile, FinaleScreen });
